...
<body>
	...
	<section>
		<div class="container">
			<h1 class="alert alert-danger">Błąd rezerwacji pokoju nr. ${errorIdRoom } w dniach: <br><br>
			${errorDataStart } - ${errorDataStop } <br><br>
			Proszę sprawdzić dostępność pokoi w podanym terminie.
			</h1>
